...
massGrid = {
            'VBfHWWlnuqq': [4000, 5000],
            #'VBFhWWlnuqq': [125, 200, 250, 300, 350, 400, 450, 500, 550,600, 650, 700, 750, 800, 900, 1000, 1500, 2000, 2500, 3000],
	    'VBfHWW2L2Nu': [4000, 5000],
...
#
  for mass in massGrid['VBfHWW2L2Nu']:
      ...
      cmd = 'python ./run_pwg_condor.py -p f -i production/V2/13TeV/Higgs/VBF_H_JHUGenV698_HWW2L2Nu_NNPDF30_13TeV/VBF_H_NNPDF30_13TeV_M'+str(mass)+'.input -g production/V2/13TeV/Higgs/gg_H_quark-mass-effects_JHUGenV698_HWW2L2Nu_NNPDF30_13TeV/JHUGen_gg_H_WW2L2Nu_reweightPMWW.input -m VBF_H -f VBfHWW2L2Nu_jhu'+str(mass)+' -q tomorrow -n 30'
  ...
  for mass in massGrid['VBfHWWlnuqq']:
      ...
      cmd = 'python ./run_pwg_condor.py -p f -i production/pre2017/13TeV/VBF_JHUGenV698_HWWLNuQQ_NNPDF30_13TeV/VBF_H_NNPDF30_13TeV_M'+str(mass)+'.input -g bin/Powheg/production/pre2017/13TeV/VBF_JHUGenV698_HWWLNuQQ_NNPDF30_13TeV/JHUGen_VBF_WWLNuQQ_reweightPMWW.input -m VBF_H -f VBfHWWlnuqq_jhu'+str(mass)+' -q tomorrow -n 30'
  ...
  for mass in massGrid['ggHToWW2L2Nu']:
      ...
      cmd = 'python ./run_pwg_condor.py -p f -i production/V2/13TeV/Higgs/gg_H_quark-mass-effects_JHUGenV698_HWW2L2Nu_NNPDF30_13TeV/gg_H_quark-mass-effects_NNPDF30_13TeV_M'+str(mass)+'.input -g production/V2/13TeV/Higgs/gg_H_quark-mass-effects_JHUGenV698_HWW2L2Nu_NNPDF30_13TeV/JHUGen_gg_H_WW2L2Nu_reweightPMWW.input -m gg_H_quark-mass-effects -f gghWW2l2nu_jhu'+str(mass)+' -q tomorrow -n 30'
  ...
  for mass in massGrid['ggHToWWlnuqq']:
      ...
      cmd = 'python ./run_pwg_condor.py -p f -i bin/Powheg/production/pre2017/13TeV/gg_H_quark-mass-effects_JHUGenV698_HWWLNuQQ_NNPDF30_13TeV/gg_H_quark-mass-effects_NNPDF30_13TeV_M'+str(mass)+'.input  -g production/pre2017/13TeV/gg_H_quark-mass-effects_JHUGenV698_HWWLNuQQ_NNPDF30_13TeV/JHUGen_gg_H_WWLNuQQ_reweightPMWW.input -m gg_H_quark-mass-effects -f gghWWlnuqq_jhu'+str(mass)+' -q tomorrow -n 30'
